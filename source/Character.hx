	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'banana-cat':
				...
				flipX = true;
			case 'cabbage-cat':
				tex = Paths.getSparrowAtlas('buggy_assets');
				frames = tex;
				animation.addByPrefix('idle', 'buggy_idle', 17);
				animation.addByPrefix('singUP', 'buggy_up', 17, false);
				animation.addByPrefix('singDOWN', 'buggy_down', 17, false);
				animation.addByPrefix('singLEFT', 'buggy_left', 17, false);
				animation.addByPrefix('singRIGHT', 'buggy_right', 17, false);
